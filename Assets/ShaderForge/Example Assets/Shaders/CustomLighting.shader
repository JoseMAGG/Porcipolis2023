...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _Gloss ("Gloss", Range(0, 1)) = 0.5170144
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Lighting:
                ...
                float3 finalColor = (attenuation*_LightColor0.rgb*((_Diffuse_var.rgb*_Color_var.rgb*floor(max(0,dot(lightDirection,normalDirection)) * _Bands_var) / (_Bands_var - 1))+UNITY_LIGHTMODEL_AMBIENT.rgb+0.0));
